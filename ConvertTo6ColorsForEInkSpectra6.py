...
parser.add_argument('--width', type=int, default=None, help='Target image width in pixels (default: 1200). Cannot be used with --scale')
parser.add_argument('--height', type=int, default=None, help='Target image height in pixels (default: 1600). Cannot be used with --scale')
parser.add_argument('--scale', type=float, default=None, help='Scale factor for output image size relative to the original (e.g., 1.0 = same size as original). Cannot be used with --width or --height')
...
# Apply default width/height when --scale is not used
